    ...
    Project(
      ...
      images: [
        ...
        ProjectImage(
          ...
          caption: 'Green skin base coat applied',
          type: ProjectImageType.process,
        ...
        ProjectImage(
          ...
          caption: 'Armor details in progress',
          type: ProjectImageType.process,
          createdAt: DateTime.now().subtract(const Duration(days: 6)),
        ),
        ProjectImage(
          id: 'img5c',
          imagePath: 'assets/images/warhammer_paints_set.jpg',
          caption: 'Color reference for armor',
      ...
      paints: [
        ...
        ProjectPaint(
          ...
          brandAvatar: 'C',
          colorHex: '#650001',
          notes: 'Armor plates and weapon details',
        ...
        ProjectPaint(
          ...
          brandAvatar: 'C',
          colorHex: '#000000',
          notes: 'Wash for recesses and depth',
          addedAt: DateTime.now().subtract(const Duration(days: 7)),
        ),
        ProjectPaint(
          paintId: 'paint5c',
          paintName: 'Ironbreaker',
          paintBrand: 'Citadel',
          brandAvatar: 'C',
          colorHex: '#A1A2A1',
          notes: 'Metal highlights on weapons',
